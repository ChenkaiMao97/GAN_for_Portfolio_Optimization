...
np.save("portfolio_data/fake_batches.npy", fake_batches.cpu().detach().numpy())
np.save("portfolio_data/real_batches.npy", real_batch.cpu().detach().numpy())
np.save("portfolio_data/scales.npy", scales.cpu().detach().numpy())
